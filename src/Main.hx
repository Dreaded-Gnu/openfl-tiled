...
class Main extends Sprite
{
  ...
  public function new()
  {
    ...
    this.mMap = new tiledfl.Map("tiled/isometric_grass_and_water/",
      "tiled/isometric_grass_and_water/isometric_grass_and_water.tmx", this.stage.stageWidth, this.stage.stageHeight);
